/*
  # Fix Authentication System and User Creation Trigger
...
DROP POLICY IF EXISTS "Auth system can update profiles" ON public.profiles;
...
-- Create policy for auth system to update profiles if needed
...
BEGIN
  ...
  IF admin_count = 0 THEN
    ...
    RAISE NOTICE '2. Or manually updating a user role in the profiles table';
  ELSE
